...
plot to a file called `graphic.png` with width of 4, height of 4, and 
...
"10+ years" is the last. Save in vector `my_levels`. Write `my_levels` 
to a csv file called '7.csv'.
